...
<section class="home-about">
    ...
    <div class="content">
        <h3>About us</h3>
        <p>Staff are super efficient, picked up an error regarding travel and hotel check in and emailed me options, so good.
Everything went smoothly as planned, second time we used TravelOnline great special offers that's what I like value for money with great service.</p>
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="content">
                ...
                <p>Easy to deal with and quick reply's if you have any questions. </p>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Adventure & Tour</h3>
                <p>Can't think of anything you need to improve.It is very simple and easy to book through your sight</p>
                <a href="book.php" class="btn">Book Now</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Adventure & Tour</h3>
                <p>I have found it very simple and easy to book through your sight </p>
                <a href="book.php" class="btn">Book Now</a>
            </div>
        </div>
    </div>
